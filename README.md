...
A double verification method has been implemented, consisting of checking the conductor cross-section based on the maximum allowable voltage drop from the installation origin, and verifying the conductor cross-section based on heating effects or the maximum allowable current of the circuit and live conductor.

The option to save the entered and calculated data has also been implemented.

I hope this tool will be useful for anyone who needs it and is interested in this subject.
